...
vale3_var_a = retorno['VALE3.SA'].var() * 250
print(vale3_var_a)

goll4_var_a = retorno['GOLL4.SA'].var() * 250
print(goll4_var_a)

dr = carteira_var - (pesos[0] ** 2 * vale3_var_a) - (pesos[1] ** 2 * goll4_var_a)
print(dr)
...
n_dr_1 = carteira_var - dr
print(n_dr_1)

n_dr_2 = (pesos[0] ** 2 * vale3_var_a) + (pesos[1] ** 2 * goll4_var_a)
print(n_dr_2)
